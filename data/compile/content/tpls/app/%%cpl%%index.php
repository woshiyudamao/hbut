 ...
 $bid++; ?>
					<li class="span2">
						<div class="thumbnail">
							...
							<div class="caption">
								<p class="text-center">
									<a class="ajax btn btn-primary" href="index.php?exam-app-index-setCurrentBasic&basicid=<?php echo $basic['basicid']; ?>" title="<?php echo $basic['basic']; ?>"><?php echo $basic['basic']; ?></a>
								</p>
							</div>
						</div>
					</li>
