		...
		<div class="span10 exambox" id="datacontent">
			<div class="examform">
				<div>
					...
					<div>
						<div class="span3">
							<div class="thumbnail"><img alt="300x200" src="<?php if($this->tpl_var['_user']['photo']){ ?><?php echo $this->tpl_var['_user']['photo']; ?><?php } else { ?>app/core/styles/images/default_user.png<?php } ?>" /></div>
						</div>
						<div class="span3">
							<div class="caption">
								<h3><?php echo $this->tpl_var['_user']['username']; ?></h3>
								<p>姓名：<?php echo $this->tpl_var['_user']['usertruename']; ?></p>
								<p>&nbsp;</p>
