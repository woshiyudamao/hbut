...
<?php } ?>
			...
			<ul class="nav nav-tabs">
				...
				<li class="pull-right">
				<a href="index.php?exam-teach-users-scorelist&page=<?php echo $this->tpl_var['page']; ?>&basicid=<?php echo $basic['basicid']; ?><?php echo $this->tpl_var['u']; ?>" title="成绩统计">成绩统计下载</a>
				</li>
			</ul>
