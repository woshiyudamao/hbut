					...
					<tr>
						...
						<td>
							<div class="btn-group">
								...
								<a class="btn confirm" msg="是否对改考生添加5分钟的考试时间？" href="index.php?exam-master-basic-addexamtime&examsessionid={x2;v:user['examsessionid']}" title="添加时间"><em class="icon-plus-sign"></em></a>
							</div>
						</td>
					</tr>
					{x2;endtree}
