				...
				<div class="tab-content">
					...
					<div id="panel-888294" class="tab-pane">
						<form action="index.php?exam-master-users-batopen" method="post" class="form-horizontal">
		                    ...
		                    <th>用户组：<input type="checkbox" class="checkall"/></th>
		            
						<tr>
		                {x2;tree:$usergroups,usergroup,bid}
							<td>
								<input type="checkbox" name="usergroupids[]" value="{x2;v:usergroup}"/>
								{x2;$usergroupsmsg[v:usergroup]['groupname']}
							</td>
							{x2;if:v:usergroup%6==0}
							<tr>
							</tr>
							{x2;endif}
				        {x2;endtree}
							...
							<div class="control-group">
						<div class="controls">
							注意 不要重复点击! 若批量开通人数过多则时间较长请耐心等待 完成会有提示。
						</div>
					</div>
							<div class="control-group">
