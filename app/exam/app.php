...
class app
{
	...
	public function index()
	{
		...
		switch($action)
		{
			...
			default: //这里是进入主页的地方
			$this->tpl->assign('basics',$this->data['openbasics']); //获取所有的考场吧?
			$this->tpl->display('index'); //展示在页面
			break;
		}
	}
